...
class Asset::EventAttachment < Asset
  ...
  VALID_CONTENT_TYPES = [*DOCUMENT_MIME_TYPES].freeze
  ...
  has_attached_file :asset,
                    ...
                    # url: "/uploads/event_attachments/:id/:style/:asset_file_name.:extension",
                    url: '/uploads/event_attachments/:id/:style.:extension',
                    path: ':rails_root/public/uploads/event_attachments/:id/:style.:extension'
  ...
  def as_json(options={})
    {
      ...
      url: self.asset.url,
      edit_url: edit_users_event_attachment_path(self.assetable_id, self.id),
      delete_url: users_event_attachment_path(self.assetable_id, self.id)
    }
  end
